...
async function seed() {
  ...
  if (userCount === 0) {
    users = await User.insertMany([
      { email: 'admin@admin.com', password: await bcrypt.hash('admin', 10), name: 'Admin SWP', role: 'Admin', avatar_initials: 'AS' },
      { email: 'alice@example.com', password: await bcrypt.hash('alice123', 10), name: 'Alice Martin', role: 'Voyageur', avatar_initials: 'AM' },
      { email: 'bob@example.com', password: await bcrypt.hash('bob123', 10), name: 'Bob Dupont', role: 'Voyageur', avatar_initials: 'BD' },
      { email: 'user@user.com', password: await bcrypt.hash('user', 10), name: 'User Test', role: 'Voyageur', avatar_initials: 'UT' },
    ]);
